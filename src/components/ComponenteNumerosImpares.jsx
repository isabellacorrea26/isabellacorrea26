...
export const ComponenteNumerosImpares = () => {
        ...
        <>
            <div className="body6">
                <div className="titulo6">
                    <h1>6. Digite un numero: </h1>
                </div>
                
                <div className="input6">
                    <input type="text" onChange={(event) => Setnum(event)} value={numero} placeholder="Número" class="form-control"/>
                    <p></p>
                    <button onClick={() => numerosImpares(numero)} class="btn btn-primary btn-sm">Numeros impares</button>
                    <p>Los números impares menores que {numero} son: {lista}</p>
                </div>
